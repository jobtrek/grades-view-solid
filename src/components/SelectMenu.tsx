  ...
  return (
    <div class="w-full">
      ...
      <div class="relative mt-2">
        <button type="button"
                class="relative w-full cursor-default rounded-md bg-sky-700 py-1.5 pl-3 pr-10 text-left text-sky-100 shadow-sm ring-1 ring-inset focus:outline-none focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6"
                aria-haspopup="listbox" aria-expanded="true" aria-labelledby="listbox-label">
          <span class="block truncate">Toto Tutu - 1ère</span>
        ...
        <ul
          ...
          --> */}
          <li class="text-gray-900 relative cursor-default select-none py-2 pl-8 pr-4"
